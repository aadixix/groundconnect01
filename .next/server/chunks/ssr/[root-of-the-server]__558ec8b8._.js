...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"40559cc557622dc6447668f32c12df465e4c52e63c":"$$RSC_SERVER_ACTION_0"},"",""] */ __turbopack_context__.s({
...
(()=>{
    const e = new Error("Cannot find module '../api/services/homeService'");
...
;
;
const $$RSC_SERVER_ACTION_0 = async function handleNewsletterSubscription(formData) {
    const email = formData.get('email');
    // Enhanced email validation
    if (!email || !email.trim()) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Please+enter+an+email+address&type=error');
    }
    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (!emailRegex.test(email.trim())) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Please+enter+a+valid+email+address&type=error');
    }
    try {
        ...
        if (result && result.rs === 1 && result.res && result.res.ResponseStatus === 1) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`?message=${encodeURIComponent(successMessage)}&type=success`);
        } else if (result && result.rs === 0) {
            // Handle API error response
            const errorMessage = result.res?.ResponseMessage || 'Subscription failed. Please try again.';
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`?message=${encodeURIComponent(errorMessage)}&type=error`);
        } else {
            // Handle unexpected response structure
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Subscription+failed.+Please+try+again.&type=error');
        }
    } catch (error) {
        console.error('Newsletter subscription error:', error);
        // More specific error handling
        if (error.message.includes('HTTP error')) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Service+temporarily+unavailable.+Please+try+again+later.&type=error');
        } else if (error.message.includes('network') || error.message.includes('fetch')) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Network+error.+Please+check+your+connection+and+try+again.&type=error');
        } else {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Something+went+wrong.+Please+try+again.&type=error');
        }
    }
};
var handleNewsletterSubscription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])($$RSC_SERVER_ACTION_0, "40559cc557622dc6447668f32c12df465e4c52e63c", null);
}}),
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"40517180a025ca5a3867e21b7410d3a374b8904c16":"$$RSC_SERVER_ACTION_0"},"",""] */ __turbopack_context__.s({
    "$$RSC_SERVER_ACTION_0": (()=>$$RSC_SERVER_ACTION_0),
...
;
;
const // Move server action outside the component
$$RSC_SERVER_ACTION_0 = async function handleSubscription(formData) {
    const email = formData.get('email');
    // Enhanced email validation
    if (!email || !email.trim()) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('?message=Please enter an email address&type=error');
...
var handleSubscription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])($$RSC_SERVER_ACTION_0, "40517180a025ca5a3867e21b7410d3a374b8904c16", null);
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: decodeURIComponent(message)
                }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__558ec8b8._.js.map